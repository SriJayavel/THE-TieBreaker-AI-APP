...
Live Demo: [THE-TieBreaker-AI-APP on Render](https://the-tiebreaker-ai-app.onrender.com/)
...
- **AI Engine:** Google GenAI SDK (Gemini API utilizing Type-Safe Structured JSON Outputs)
...
- **Multi-Option Comparison:** Supports advanced weighted evaluation matrices across multiple custom scenarios simultaneously.
- **Client-Side Persistence:** Localized session caching ensures user scenarios are maintained safely across browser refreshes.
...
```bash
git clone [https://github.com/SriJayavel/THE-TieBreaker-AI-APP.git](https://github.com/SriJayavel/THE-TieBreaker-AI-APP.git)
cd THE-TieBreaker-AI-APP
